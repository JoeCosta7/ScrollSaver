    ...
    if (!isPdfViewer) {
        await chrome.scripting.executeScript({
            ...
            func: (px, py, plabel) => {
                ...
                el.className = 'saved-anchor-marker bg-red-500 text-white text-large font-semibold px-4 py-2 rounded-full shadow-md tracking-wide select-none';
                el.style.cssText = `position:absolute; left:0; top:${py}px; z-index:10000`;
